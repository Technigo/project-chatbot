...
const extraButton = (extraBtnText, extraBtnId) => {
    form.innerHTML += `
  <button class="exit-btn" id="${extraBtnId}" type="submit" value="yes">${extraBtnText}</button>
`
    // This is where the "code" argument is replaced with the actual code
    insertStyle(`
    .exit-btn {
...
btnOne.innerHTML = "Oldie 🤓";
      btnTwo.innerHTML = "Fresh release! 🪩";
