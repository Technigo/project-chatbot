...
const showMessage = (message, sender) => {
  ...
  // The scrollTop property sets or returns the number of pixels an element's content is scrolled vertically. It makes the chat scroll to the last message when there are too many to be shown in the chat box
