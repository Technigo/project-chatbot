...
//Question 2.1 Yes and No-buttons pop up, and the user should click on one or the other
const yesOrNo = () => {
  inputWrapper.innerHTML = `
...
//Question 3: Bot's answer depends on if user chooses Yes ( if (selection === 'option1') ) or No ( else if (selection === 'option2') ) in Question 2
const doYouNeedHelp = (selection) => {
  if (selection === 'option1') {
   ...
   const moodChoice = () =>  {
    ...
    showMessage(`Well, now that you know it works, you're more than welcome back once you need my help!`, 'bot')
...
//Question 4: Bot suggests movie. The bot's answer depends on which Mood-button has been chosen ('optHappy', 'optSad', 'optAngry'). 
...
//The last reply from bot: The bot replies to the user's choice of films, and thanks the user for using the chat bot.
...
// We have removed all console.logs since the code is working as we want it to. 