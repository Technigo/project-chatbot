...
const kittenLibrary = { 
  ...
  pictures: [
    ...
    {
      imageSrc: './assets/kittenpics/freddie-marriage-iYQC9xWMvw4-unsplash.jpg',
      color: 'brown',
      environmentPreference: 'indoors',
      furState: 'furry',
    },
    {
      imageSrc: './assets/kittenpics/joe-cleary-klH-f7mw2Ws-unsplash.jpg',
      color: 'brown',
      environmentPreference: 'indoors',
      furState: 'furry',
    },
    {
      imageSrc: './assets/kittenpics/ramiz-dedakovic-jerh2Nj1XWY-unsplash.jpg',
      color: 'grey',
      environmentPreference: 'indoors',
      furState: 'furry',
    },
    {
      imageSrc: './assets/kittenpics/raoul-droog-yMSecCHsIBc-unsplash.jpg',
      color: 'grey',
      environmentPreference: 'indoors',
      furState: 'furry',
    },
    ...
    {
      imageSrc: './assets/kittenpics/timur-m-SAKLELG-pO8-unsplash.jpg',
      color: 'white',
      environmentPreference: 'indoors',
      furState: 'furry',
    },
    {
      imageSrc: './assets/kittenpics/tran-mau-tri-tam-wiqbi_Uyvx8-unsplash.jpg',
      color: 'white',
      environmentPreference: 'indoors',
      furState: 'furry',
    },
